...
export default function Chat({ pdfText, name }: { pdfText: string, name: string }) {
  ...
  return (
    <div className="w-full md:w-1/2 h-screen">
      ...
      <ul className="flex flex-col pb-6 pt-2 markdown box-border overflow-auto h-[89%]">
      ...
      <form
        ...
        className="flex gap-2 p-2 w-full bg-zinc-900 rounded-t-lg h-12 md:h-14"
      >
        <input
          type="text"
        ...
        <button
          type="submit"
          disabled={!input.trim()}
          className="bg-orange-600 px-1.5 md:px-3 rounded-lg border-2 text-xl border-orange-800 disabled:bg-zinc-800"
        >
          Ask
        </button>
      </form>
